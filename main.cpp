...
int main(int argc, char **argv) {
    ...
    MPI_Gatherv(&my_img_sym_basic[nHard * widthBoundary + nHard], counts_type[my_rank], vector_type, &img_basic[0],
                &counts_type[0], &displs_type[0], vector_type, 0, MPI_COMM_WORLD);
    ...
    bm3d_2nd_step(sigma, my_img_sym_noisy, my_img_sym_basic, my_img_sym_denoised, widthBoundary, heightBoundary, nWien,
                  kWien, pWien, ranks, my_rank, int(local_rows + (2 * nHard)), table_2D_img, table_2D_est);
